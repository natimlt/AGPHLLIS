...
class AuthManager {
    constructor() {
        ...
        this.permissions = {
            ...
            'Viewer': [
                'view_dashboard', 'view_patients', 'view_samples',
                'view_reports', 'view_tat', 'view_availability',
                'view_satisfaction'
            ],
    ...
    async initDefaultUsers() {
        ...
        if (users.length === 0) {
            ...
            const defaultUsers = [
                { username: 'admin', password: 'Admin@12345', email: 'asratgenet2@gmail.com', fullName: 'Asrat Genet', role: 'Administrator', phone: '+251-918225730', facilityId: null },
                ...
                { username:'logistic', password: 'Logistic@12345', email: 'logistic@agphl.com', fullName: 'Logistic', role: 'Logistic', phone: '+251-900-000-004', facilityId: primaryFacilityId }
            ];
     ...
     * Not a replacement for server-side bcrypt/argon2, but far stronger than a
