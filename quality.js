...
class QualityManager {
    ...
    initDefaultEQA() {
        const facilities = [
            ...
            { name: 'Wunbire Wundige Health Centre', type: 'Health Centre', isMain: false }
        ];
    ...
    renderEQA() {
        ...
        let html = `
            <div style="margin-bottom: 1rem; display: flex; gap: 0.5rem; flex-wrap: wrap;">
                <button class="btn btn-primary btn-sm" onclick="document.getElementById('eqaModal').style.display='flex'">
    ...
    saveEQA() {
        const data = {
            ...
            eqaType: document.getElementById('eqaType').value,
